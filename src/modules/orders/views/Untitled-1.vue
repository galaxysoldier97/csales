...
<template>  
    ...
    <div class="card">
        <DataTable v-model:filters="filters" size="small" :value="customers" paginator showGridlines :rows="10" dataKey="id"
            ...
            <Column headerStyle="text-align: center" bodyStyle="text-align: center; overflow: visible">
                <template  #body="{ data }">
                    <Button @click="console.debug(data)" type="button" icon="pi pi-pencil" :size="small" text rounded  />
                </template>
            </Column>
        </DataTable>
    </div>
