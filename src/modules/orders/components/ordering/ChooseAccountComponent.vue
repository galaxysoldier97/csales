<template>
    ...
    <div class="sm:flex sm:items-center">
      <div class="sm:flex-auto">
        <h1 class="text-base font-semibold leading-6 text-primary-700 dark:bg-slate-700 dark:text-primary-100">Seleccione la cuenta para el servicio hogar</h1>
    ...
    <div class="mx-2 flow-root sm:mx-0"> 
        ...
        <select v-model="form_value" class="col-span-6 sm:col-span-3 dark:bg-slate-700 dark:text-white"> 
