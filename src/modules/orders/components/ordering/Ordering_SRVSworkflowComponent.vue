<template>
    ...
    <div class="sm:flex sm:items-center">
      <div class="sm:flex-auto">
        <h1 class="text-base font-semibold leading-6 text-primary-700 dark:text-primary-100">La cuenta tiene contrataciones en proceso. Debe esperar a que finalice para poder continuar</h1>
