export default {
    ...
    weekheader: {
        class: ['leading-5', 'text-surface-600 dark:text-white', 'opacity-60 cursor-default']
    },
    weeknumber: {
        class: ['text-surface-600 dark:text-white', 'opacity-60 cursor-default']
    },
    weekday: {
        class: [
            // Colors
    ...
    weeklabelcontainer: ({ context }) => ({
        class: [
            ...
            // Colors
            {
                'text-surface-600 dark:text-white bg-transparent': !context.selected && !context.disabled,
                'text-primary-700 dark:text-primary-100 bg-primary-100': context.selected && !context.disabled
            },
    ...
    daylabel: ({ context }) => ({
        class: [
            ...
            // Colors
            {
                ...
                'text-surface-600 dark:text-white bg-transparent': !context.selected && !context.disabled && !context.date.today,
                'text-primary-700 dark:text-primary-100 bg-primary-100 dark:text-surface-0 dark:bg-primary-300/40': context.selected && !context.disabled
            },
