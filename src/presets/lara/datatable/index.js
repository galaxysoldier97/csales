export default {
    ...
    column: {
        headercell: ({ context, props }) => ({
            class: [
                ...
                // Color
                (props.sortable === '' || props.sortable) && context.sorted ? 'bg-primary-50 text-primary-700 dark:text-primary-100' : 'bg-surface-50 text-surface-700',
                (props.sortable === '' || props.sortable) && context.sorted ? 'dark:text-white dark:bg-primary-400/30' : 'dark:text-white dark:bg-surface-800',
                'border-surface-200 dark:border-surface-700 ',
        ...
        sort: ({ context }) => ({
            class: [context.sorted ? 'text-primary-500' : 'text-surface-700', context.sorted ? 'dark:text-primary-400' : 'dark:text-white']
        }),
        ...
        sorticon: ({ context }) => ({
            class: ['ml-2', context.sorted ? 'text-primary-700 dark:text-primary-100 dark:text-white' : 'text-surface-700 dark:text-white']
        }),
        sortbadge: {
            class: [
                // Flex & Alignment
                ...
                // Color
                'text-primary-700 dark:text-primary-100 dark:text-white',
        ...
        filterrowitem: ({ context }) => ({
            class: [
                ...
                // Color
                { 'text-surface-700 dark:text-white': !context?.highlighted },
                { 'bg-surface-0 dark:bg-surface-800 text-surface-700 dark:text-white': !context?.highlighted },
                { 'bg-primary-100 dark:bg-primary-400/40 text-primary-700 dark:text-primary-100 dark:text-white': context?.highlighted },
                { 'bg-primary-50 dark:bg-primary-400/40 text-primary-700 dark:text-primary-100 dark:text-white': context?.highlighted },
        ...
        filteroperatordropdown: {
            ...
            input: ({ props }) => ({
                class: [
                    ...
                    'bg-transparent',
                    'border-0',
                    { 'text-surface-800 dark:text-white': props.modelValue, 'text-surface-400 dark:text-surface-500': !props.modelValue },
                    'placeholder:text-surface-400 dark:placeholder:text-surface-500',
            ...
            item: ({ context }) => ({
                class: [
                    ...
                    { 'bg-surface-50 dark:bg-surface-600/60 text-surface-700 dark:text-white': context.focused && !context.selected },
                    { 'bg-primary-100 dark:bg-primary-400/40 text-primary-700 dark:text-primary-100 dark:text-white': context.focused && context.selected },
                    { 'bg-primary-50 dark:bg-primary-400/40 text-primary-700 dark:text-primary-100 dark:text-white': !context.focused && context.selected },
        ...
        filtermenubutton: ({ context }) => ({
            class: [
                ...
                // Color
                { 'bg-primary-50 text-primary-700 dark:text-primary-100': context.active },
                'dark:text-white dark:hover:text-white/80 dark:bg-surface-800',
        ...
        radiobutton: ({ context }) => ({
            class: [
                ...
                // Color
                { 'text-surface-700 dark:text-white': !context.checked },
    ...
    bodyrow: ({ context, props }) => ({
        class: [
            // Color
            'dark:text-white',
            { 'bg-primary-50 text-primary-700 dark:text-primary-100 dark:bg-primary-400/30': context.selected },
    ...
    rowexpansion: {
        class: 'bg-surface-0 dark:bg-surface-800 text-surface-600 dark:text-white'
    },
    rowgroupheader: {
        class: ['sticky z-20', 'bg-surface-0 text-surface-600 dark:text-white', 'dark:bg-surface-800']
    },
    rowgroupfooter: {
        class: ['sticky z-20', 'bg-surface-0 text-surface-600 dark:text-white', 'dark:bg-surface-800']
    },
