export default {
    root: ({ props, context, parent }) => ({
        class: [
            ...
            'leading-[normal]',
            {
                ...
                'text-sm py-2 px-6': props.size === 'small',
            ...
            // Primary Button
            {
                'text-white dark:text-white': !props.link && props.severity === null && !props.text && !props.outlined && !props.plain,
                'bg-primary-200 dark:bg-primary-300': !props.link && props.severity === null && !props.text && !props.outlined && !props.plain,
                'border border-primary-200 dark:border-primary-400': !props.link && props.severity === null && !props.text && !props.outlined && !props.plain
            },
            // Primary Text Button
            ...
            // Secondary Button
            {
                'text-white dark:text-white': props.severity === 'secondary' && !props.text && !props.outlined && !props.plain,
            ...
            // Info Button
            {
                'text-white dark:text-white': props.severity === 'info' && !props.text && !props.outlined && !props.plain,
            ...
            // Warning Button
            {
                'text-white dark:text-white': props.severity === 'warning' && !props.text && !props.outlined && !props.plain,
            ...
            // Help Button
            {
                'text-white dark:text-white': props.severity === 'help' && !props.text && !props.outlined && !props.plain,
            ...
            // Danger Button
            {
                'text-white dark:text-white': props.severity === 'danger' && !props.text && !props.outlined && !props.plain,
            ...
            // Plain
            { 'hover:bg-gray-500 hover:border-gray-600': props.plain && !props.outlined && !props.text },
            // Text & Outlined Button
            { 'hover:bg-surface-300/20': props.plain && (props.text || props.outlined) },

            // Primary
            { 'hover:bg-primary-500 dark:hover:bg-primary-300 hover:border-primary-600 dark:hover:border-primary-300': !props.link && props.severity === null && !props.text && !props.outlined && !props.plain },
    ...
    label: ({ props }) => ({
        class: [
            'duration-200',
            'uppercase font-normal uppercase font-normal tracking-widest',
            {
