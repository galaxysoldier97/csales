export default {
    ...
    pagebutton: ({ context }) => ({
        class: [
            ...
            {
                'bg-primary-50 border-primary-50 dark:border-transparent text-primary-700 dark:text-primary-100 dark:text-surface-0 dark:bg-primary-400/30': context.active
            },
