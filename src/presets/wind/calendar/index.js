export default {
    ...
    weekheader: {
        class: ['leading-6 text-sm font-normal', 'text-surface-600 dark:text-white', 'opacity-40 cursor-default', 'mb-2']
    },
    weeknumber: {
        class: ['text-surface-600 dark:text-white font-normal', 'opacity-40 cursor-default']
    },
    weekday: {
        class: [
            // Colors
